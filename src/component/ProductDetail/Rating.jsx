...
const Rating = ({dataRating, maxRate}) => {
    ...
    for(let i = 0; i < dataRating; i++){
        const Rouge = <svg width="30" height="30" viewBox="0 0 30 30" fill="none" key={starsArray.length} xmlns="http://www.w3.org/2000/svg">
    ...
    for(let i = 0; i < incrementEtoile; i++){
        const Grise = <svg width="30" height="30" viewBox="0 0 30 30" fill="none" key={starsArray.length} xmlns="http://www.w3.org/2000/svg">
